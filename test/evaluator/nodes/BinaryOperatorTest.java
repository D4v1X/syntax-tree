...
public class BinaryOperatorTest {
    ...
    public void testAddDoubleDouble() {
        Node node = new BinaryOperation(BinaryOperator.add, new Constant(new Double(3.0)), new Constant(new Double(5.0)));
    ...
    public void testAddDoubleInteger() {
        Node node = new BinaryOperation(BinaryOperator.add, new Constant(new Double(3.0)), new Constant(new Integer(5)));
        assertEquals(java.lang.Double.class, node.evaluate().getValue().getClass());
        assertEquals(8.0, (double) node.evaluate().getValue(), 0.001);
    }
    ...
    public void testAddIntegerDouble() {
        Node node = new BinaryOperation(BinaryOperator.add, new Constant(new Integer(3)), new Constant(new Double(5.0)));
        assertEquals(java.lang.Double.class, node.evaluate().getValue().getClass());
        assertEquals(8.0, (double) node.evaluate().getValue(), 0.001);
    }
    ...
    public void testAddIntegerInteger() {
        Node node = new BinaryOperation(BinaryOperator.add, new Constant(new Integer(3)), new Constant(new Integer(5)));
